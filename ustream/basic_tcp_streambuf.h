/*************************************************************************
    > File Name: basic_tcp_streambuf.h
    > Author: sudoku.huang
    > Mail: sudoku.huang@gmail.com 
    > Created Time: Tue Sep 20 07:38:05 CST 2016
 ************************************************************************/
 
#ifndef _BASIC_TCP_STREAMBUF_H__
#define _BASIC_TCP_STREAMBUF_H__

#include <iostream>
#include <unistd.h>

class basic_tcp_streambuf
	: public std::streambuf
{
public:
	basic_tcp_streambuf(ssize_t buf_size)
		: buf_size_(buf_size)
	{
		/*
